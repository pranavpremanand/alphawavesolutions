      ...
      <div className="bg-gradient-to-b from-primary to-primary/70 rounded-2xl w-fit p-7">
        ...
        >
          ...
          <button
            ...
            className="mt-4 bg-gradient-to-r from-primary to-secondary border border-white px-5 py-3 rounded-full hover:bg-gradient-to-r hover:from-secondary hover:to-primary text-white hover:-translate-y-1 duration-300 transition-all"
          >
            Send Message
          </button>
        </form>
