    ...
    <>
      ...
      <section className="py-[3rem] wrapper grid gap-10 lg:grid-cols-2">
        <div className="flex flex-col">
          <h1 data-aos="fade-right" className="heading">
            Alphawavesolutions Leading in Software Development and Advanced Tech
            Solutions
          </h1>
          <p data-aos="fade-right" className="description mt-4">
            Alphawavesolutions was founded with a vision to transform businesses by
      ...
      <section className="wrapper">
        ...
        <h5 data-aos="fade-right" className="text-2xl mt-4">
          The Journey of Alphawavesolutions:
        </h5>
        <p data-aos="fade-right" className="description mt-3">
          At Alphawavesolutions, we lead the charge in reshaping the digital world. By
        ...
        <p className="mt-5 description">
          At Alphawavesolutions, we’re not just innovating technology — we’re solving
